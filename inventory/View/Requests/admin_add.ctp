...
<aside class="right-side">
  <section class="content-header">
    <h1> Add Requisition Request <small>Here you can Add Requisition Request</small> </h1>
    <ol class="breadcrumb">
      <li>
        ...
        <div class="col-xs-12">
            ...
            <div class="box-body" style="clear: both; overflow: hidden;">
              <div class="tab-pane active">
                <div class="form-group">
                  <label for="request_for"><span class="required">*</span>Request For</label>
                  <?php
		 echo $this->Form->input('request_for', array('label'=>false, 'div'=>false, 'class' => 'form-control', 'empty'=>__('Select Request For'), 'data-validation' => 'required','options'=>Configure::read('site.request_for'))); ?>
                </div>
		 ...
		 echo $this->Form->input('request_returnto', array('label'=>false, 'div'=>false, 'class' => 'form-control datepicker', 'placeholder'=>__('Items to be return on'),'type'=>'text')); ?>
				...
				<div id="gallery_div" style="display:none;">
                  ...
                  <?php
		 echo $this->Form->input('Gallery', array('label'=>false, 'div'=>false, 'multiple'=>"checkbox")); ?>
                </div>
		 ...
		 echo $this->Form->input('gallery_collectiondate', array('label'=>false, 'div'=>false, 'class' => 'form-control datepicker', 'placeholder'=>__('Items to be collect on'),'type'=>'text')); ?>
				...
				<div id="request_item_div" style="display:none;">
				 <table class="in_table" style="width:100%;">
                  
                    <tr>
                      <th style="width:60%;text-align:left;"><?php echo __('Item'); ?></th>
					  <th style="width:13%;"><?php echo __('Available Stock'); ?></th>
					  <th style="width:13%;"><?php echo __('Price / pack (RM)'); ?></th>
					  <th style="width:14%;"><?php echo __('Quantity & Item'); ?></th>
					</tr>
                 </table>
					 ...
					 <div class="tab_col">
						...
						<ul class="add_tab">
							...
							<li style="width:13%;"><?php echo h($item['Item']['item_stocklevel']); ?></li>
							<li style="width:13%;"><?php echo h($item['Item']['item_unitprice']); ?> <?php echo h($item['Item']['item_measurementunit']); ?></li>
							<li style="width:14%;"><input size="6" value="" type="text" name="qty[]" class="item_blur" dir="<?php echo h($item['Item']['item_stocklevel']); ?>" />
				...
				<ul class="add_tab" id="request_postby" style="display:none;">
					<li style="width:60%;text-align:left;">&nbsp;</li>
					<li style="width:13%;">&nbsp;</li>
					<li style="width:13%;">&nbsp;</li>
					<li style="width:14%;"><?php echo $UsersDetails['first_name'];?> <?php echo $UsersDetails['last_name'];?></li>
				</ul>
