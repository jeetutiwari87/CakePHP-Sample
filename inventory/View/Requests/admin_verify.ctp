...
<aside class="right-side">
  <section class="content-header">
    <h1> Requisition Verify Request <small>Here you can manage Requisition Verify Request</small> </h1>
    <ol class="breadcrumb">
      <li>
      ...
      <div class="row">
        <div class="col-xs-12">
		 ...
		 echo $this->Form->input('gallery_collectiondate', array('label'=>false, 'div'=>false, 'class' => 'form-control datepicker', 'placeholder'=>__('Items to be collect on'),'type'=>'text')); ?>
				...
				<div class="form-group">
				 <?php
		 echo $this->Form->input('request_status', array('label'=>false, 'div'=>false, 'legend' => false,"type"=>"radio",'options'=>array("5"=>"Returned incomplete","6"=>"Returned ok"), 'data-validation' => 'required')); ?>
				</div>
				...
				<div id="request_item_div">
				 <table class="in_table" style="width:100%;">
                    ...
                    <tr>
                      <th style="width:22%;text-align:left;"><?php echo __('Item'); ?></th>
					  <th style="width:9%;"><?php echo __('Available Stock'); ?></th>
					  <th style="width:9%;"><?php echo __('Price / pack (RM)'); ?></th>
					  <th style="width:9%;"><?php echo __('Quantity & Item Requested'); ?></th>
					  <th style="width:9%;"><?php echo __('Quantity & Item Approved'); ?></th>
					  <th style="width:9%;"><?php echo __('Quantity & Item Collected'); ?></th>
					  <th style="width:9%;"><?php echo __('Quantity & Item Return'); ?></th>
					  <th style="width:9%;"><?php echo __('Quantity & Item Return'); ?></th>
					  <th style="width:15%;"><?php echo __('Remark'); ?></th>
					</tr>
                 </table>
					 ...
					 <div class="tab_col">
						...
						?>
						<ul class="add_tab">
							<li style="width:22%;text-align:left;"><img src="<?php echo Router::url('/',true);?>img/arro_tab.png" alt="image" style="margin-right:3px;position:relative;top:-3px;" /><?php echo h($item['Item']['item_name']); ?><span style="float:right;">
							...
							<li style="width:9%;"><?php echo h($item['Item']['item_stocklevel']+$item['Item']['reqitem_quantity']); ?></li>
							<li style="width:9%;"><?php echo h($item['Item']['item_unitprice']); ?> <?php echo h($item['Item']['item_measurementunit']); ?></li>
							<li style="width:9%;"><?php echo h($item['Item']['reqitem_quantity']); ?></li>
							<li style="width:9%;"><?php echo h($item['Item']['reqitem_quantityapproved']); ?></li>
							<li style="width:9%;"><?php echo h($item['Item']['reqitem_quantitycollected']); ?></li>
							<li style="width:9%;"><?php echo h($item['Item']['reqitem_quantityreturned']); ?></li>
							
							<li style="width:9%;"><input size="6" value="<?php echo h($item['Item']['reqitem_quantityreturned']); ?>" type="text" name="qty[]" class="item_blur" dir="<?php echo h($item['Item']['reqitem_quantitycollected']); ?>" />
							...
							<li style="width:15%;">
							<b>Collect Remark: </b><?php echo $item['Item']['collect_remark']; ?><br />
							<b>Return Remark: </b><?php echo $item['Item']['return_remark']; ?>
							
							<textarea style="width:155px;"  type="text" name="remarks[]"><?php echo $item['Item']['verify_remark']; ?></textarea></li>
				...
				<ul class="add_tab">
					<li style="width:22%;text-align:left;">&nbsp;</li>
					<li style="width:9%;">&nbsp;</li>
					<li style="width:9%;">&nbsp;</li>
					<li style="width:9%;"><?php echo (isset($this->request->data['Requestedby']['first_name']) && $this->request->data['Requestedby']['first_name']!='')?$this->request->data['Requestedby']['first_name'].' '.$this->request->data['Requestedby']['last_name']:'';?></li>
					<li style="width:9%;"><?php echo (isset($this->request->data['Approvedby']['first_name']) && $this->request->data['Approvedby']['first_name']!='')?$this->request->data['Approvedby']['first_name'].' '.$this->request->data['Approvedby']['last_name']:'';?></li>
					<li style="width:9%;"><?php echo (isset($this->request->data['Collectedby']['first_name']) && $this->request->data['Collectedby']['first_name']!='')?$this->request->data['Collectedby']['first_name'].' '.$this->request->data['Collectedby']['last_name']:'';?></li>
					<li style="width:9%;"><?php echo (isset($this->request->data['Returnedby']['first_name']) && $this->request->data['Returnedby']['first_name']!='')?$this->request->data['Returnedby']['first_name'].' '.$this->request->data['Returnedby']['last_name']:'';?></li>
					<li style="width:9%;"><?php echo (isset($this->request->data['Verifiedby']['first_name']) && $this->request->data['Verifiedby']['first_name']!='')?$this->request->data['Verifiedby']['first_name'].' '.$this->request->data['Verifiedby']['last_name']:'';?></li>
					
					<li style="width:15%; display:none;" id="request_postby"><?php echo $UsersDetails['first_name'];?> <?php echo $UsersDetails['last_name'];?></li>
...
jQuery(document).ready(function(){
  ...
  jQuery('.item_blur').on('blur',function(){
     ...
     if(parseInt(jQuery(this).val()) > parseInt(jQuery(this).attr("dir"))){
	   alert('Less than equal to requested stock');
	   jQuery(this).val('');
	 }
  });
