...
<aside class="right-side">
  <section class="content-header">
    <h1> Requisition Return Request <small>Here you can manage Requisition Return Request</small> </h1>
    <ol class="breadcrumb">
      <li>
		 ...
		 echo $this->Form->input('gallery_collectiondate', array('label'=>false, 'div'=>false, 'class' => 'form-control datepicker', 'placeholder'=>__('Items to be collect on'),'type'=>'text')); ?>
				...
				<div id="request_item_div">
				 <table class="in_table" style="width:100%;">
                    ...
                    <tr>
                      <th style="width:31%;text-align:left;"><?php echo __('Item'); ?></th>
					 ...
					 <div class="tab_col">
						...
						?>
						<ul class="add_tab">
							<li style="width:31%;text-align:left;"><img src="<?php echo Router::url('/',true);?>img/arro_tab.png" alt="image" style="margin-right:3px;position:relative;top:-3px;" /><?php echo h($item['Item']['item_name']); ?><span style="float:right;">
							...
							<li style="width:9%;"><input size="6" value="<?php echo h($item['Item']['reqitem_quantitycollected']); ?>" type="text" name="qty[]" class="item_blur" dir="<?php echo h($item['Item']['reqitem_quantitycollected']); ?>" />
							...
							<li style="width:15%;">
							<?php echo $item['Item']['collect_remark']; ?>
							<textarea style="width:155px;"  type="text" name="remarks[]"></textarea></li>
				...
				<ul class="add_tab">
					<li style="width:31%;text-align:left;">&nbsp;</li>
					<li style="width:9%;">&nbsp;</li>
					<li style="width:9%;">&nbsp;</li>
