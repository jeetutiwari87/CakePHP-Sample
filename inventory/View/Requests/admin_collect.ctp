...
<aside class="right-side">
  <section class="content-header">
    <h1> Requisition Collect Request <small>Here you can manage Requisition Collect Request</small> </h1>
    <ol class="breadcrumb">
      <li>
		 ...
		 echo $this->Form->input('gallery_collectiondate', array('label'=>false, 'div'=>false, 'class' => 'form-control datepicker', 'placeholder'=>__('Items to be collect on'),'type'=>'text')); ?>
				...
				<div id="request_item_div">
				 <table class="in_table" style="width:100%;">
                    ...
                    <tr>
                      <th style="width:40%;text-align:left;"><?php echo __('Item'); ?></th>
					  <th style="width:9%;"><?php echo __('Available Stock'); ?></th>
					  <th style="width:9%;"><?php echo __('Price / pack (RM)'); ?></th>
					  <th style="width:9%;"><?php echo __('Quantity & Item'); ?></th>
					  <th style="width:9%;"><?php echo __('Quantity & Item for Approved'); ?></th>
					 ...
					 <div class="tab_col">
						...
						?>
						<ul class="add_tab">
							<li style="width:40%;text-align:left;"><img src="<?php echo Router::url('/',true);?>img/arro_tab.png" alt="image" style="margin-right:3px;position:relative;top:-3px;" /><?php echo h($item['Item']['item_name']); ?><span style="float:right;">
							...
							<li style="width:9%;"><input size="6" value="<?php echo h($item['Item']['reqitem_quantityapproved']); ?>" type="text" name="qty[]" class="item_blur" dir="<?php echo h($item['Item']['reqitem_quantityapproved']); ?>" />
							...
							<li style="width:15%;"><textarea style="width:155px;"  type="text" name="remarks[]"></textarea></li>
				...
				<ul class="add_tab">
					<li style="width:40%;text-align:left;">&nbsp;</li>
					<li style="width:9%;">&nbsp;</li>
					<li style="width:9%;">&nbsp;</li>
