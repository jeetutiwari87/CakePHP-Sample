	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<h3 class="page-title">
					Edit Manager <small>Here you can Edit your manager</small>
				</h3>
				<ul class="breadcrumb">
					...
					<div class="tab-content">
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4>
									<i class="icon-reorder"></i>Edit Manager
								</h4>
...
<script type="text/javascript">
 jQuery(window).load(function(){
    ...
    jQuery("#ManagerAdminEditForm").validationEngine({promptPosition : "bottomLeft"});
