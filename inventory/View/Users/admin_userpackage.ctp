...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            ...
            <small><?php echo __('Here you can edit seller package'); ?></small>
        </h1>
        <ol class="breadcrumb">
            <li>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#stntab1" aria-expanded="true"><?php echo __('Package Information'); ?></a></li>
                            </ul>
                            <div class="tab-content">

                                <?php
                                include 'frm/admin_packageform.ctp';
                                ?>
