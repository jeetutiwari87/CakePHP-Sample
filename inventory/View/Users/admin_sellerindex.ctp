...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
                        <?php echo __('Sellers');?>
            <small><?php echo __('Here you can manage all sellers');?></small>
        </h1>
        <ol class="breadcrumb">
                                ...
                                <div class="col-xs-6">
                                    <div id="example1_length" class="dataTables_length">
										...
										<?php foreach (Configure::read('Admin.showperpage') as $showpage): ?>
                                            ...
                                            <input type="hidden" name="current_url" id="current_url" value="<?php echo Router::url('/');?>admin/<?php echo $this->params['controller'];?>/sellerindex" />
