...
<aside class="right-side">
  <section class="content-header">
    <h1> Add Email Template <small>Here you can AddEmail Template</small> </h1>
    <ol class="breadcrumb">
      <li>
        ...
        <div class="col-xs-12">
            ...
            <div class="box-body">
              <div class="tab-pane active">
                <div class="form-group">
                  ...
                  <?php
		 echo $this->Form->input('title', array('label'=>false, 'div'=>false, 'class' => 'form-control', 'placeholder'=>__('Title'), 'data-validation' => 'required')); ?>
                </div>
                <div class="form-group">
		 ...
		 echo $this->Form->input('status', array('label'=>false, 'div'=>false, 'class' => 'fancycheck')); ?>
                ...
                <div class="form-group">
                  ...
                  <?php
		 echo $this->Form->input('is_html', array('label'=>false, 'div'=>false, 'class' => 'form-control', 'placeholder'=>__('Is Html'))); ?>
                </div>
              </div>
            </div>
            <!-- /.box-body -->
